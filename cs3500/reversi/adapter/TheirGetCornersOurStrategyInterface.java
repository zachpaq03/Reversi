...
import cs3500.reversi.provider.GetCorners;
...
/**
 * A class the converts our provider's GetCorners strategy to our strategy interface so
 * that it can be used with our model.
 */
public class TheirGetCornersOurStrategyInterface extends GetCorners implements ReversiStrategy {
  private int size;
   ...
   */
  public TheirGetCornersOurStrategyInterface(Strategy backup) {
    super(backup);
  }
