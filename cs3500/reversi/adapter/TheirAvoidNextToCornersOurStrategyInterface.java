...
import cs3500.reversi.provider.AvoidNextToCorners;
...
/**
 * A class the converts our provider's AvoidNextToCorners strategy to our strategy interface so
 * that it can be used with our model.
 */
public class TheirAvoidNextToCornersOurStrategyInterface extends AvoidNextToCorners
        implements ReversiStrategy {
  private int size;
  private int gridLength;

  /**
   * A constructor for this strategy.
   *
   * @param backup the backup strategy.
   */
  public TheirAvoidNextToCornersOurStrategyInterface(Strategy backup) {
    super(backup);
  }
